	...
	<div class="col-md-9">
		{!! Form::model($kitab, ['class' => 'form-horizontal', 'url' => $url, 'method' => $method, 'files' => true]) !!}
			...
			<div class="form-group{{ $errors->has('penulis') ? ' has-error' : '' }}">
				<label for="penulis" class="col-sm-3 col-md-3 control-label">Penulis:</label>
				<div class="col-md-9">
			...
			<div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
				<label for="file" class="col-sm-3 col-md-3 control-label">File PDF:</label>
				<div class="col-md-9">
			...
			<div class="form-group{{ $errors->has('materi') ? ' has-error' : '' }}">
				<label for="materi" class="col-sm-3 col-md-3 control-label">Keterangan:</label>
				<div class="col-md-9">
