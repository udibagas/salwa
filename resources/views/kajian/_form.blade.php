	...
	<div class="col-md-9">
		{!! Form::model($kajian, ['class' => 'form-horizontal', 'url' => $url, 'method' => $method, 'files' => true]) !!}
			...
			<div class="form-group{{ $errors->has('setiap_jam') ? ' has-error' : '' }}">
				<label for="setiap_jam" class="col-md-3 control-label">Jam:</label>
				<div class="col-md-9">
			...
			<div class="form-group{{ $errors->has('pic_nama_ikhwan') ? ' has-error' : '' }}">
				<label for="pic_nama_ikhwan" class="col-md-3 control-label">Name CP Ikhwan:</label>
				<div class="col-md-9">
			...
			<div class="form-group{{ $errors->has('pic_phone_ikhwan') ? ' has-error' : '' }}">
				<label for="pic_phone_ikhwan" class="col-md-3 control-label">Phone CP Ikhwan:</label>
				<div class="col-md-9">
			...
			<div class="form-group{{ $errors->has('pic_phone_akhwat') ? ' has-error' : '' }}">
				<label for="pic_phone_akhwat" class="col-md-3 control-label">Phone CP Akhwat:</label>
				<div class="col-md-9">
