	...
	<div class="col-sm-9">
		{!! Form::model($produk, ['class' => 'form-horizontal', 'url' => $url, 'method' => $method, 'files' => true]) !!}
			...
			<div class="form-group{{ $errors->has('group_id') ? ' has-error' : '' }}">
				<label for="group_id" class="col-sm-3 control-label">Kategori:</label>
				<div class="col-sm-9">
			...
			<div class="form-group{{ $errors->has('penulis') ? ' has-error' : '' }}">
				<label for="group_id" class="col-sm-3 control-label">Penulis:</label>
				<div class="col-sm-9">
			...
			<div class="form-group{{ $errors->has('penerbit') ? ' has-error' : '' }}">
				<label for="group_id" class="col-sm-3 control-label">Penerbit:</label>
				<div class="col-sm-9">
			...
			<div class="form-group{{ $errors->has('harga') ? ' has-error' : '' }}">
				<label for="group_id" class="col-sm-3 control-label">Harga:</label>
				<div class="col-sm-9">
			...
			<div class="form-group{{ $errors->has('sinopsis_kecil') ? ' has-error' : '' }}">
				<label for="sinopsis_kecil" class="col-sm-3 control-label">Sinopsis Kecil:</label>
				<div class="col-sm-9">
			...
			<div class="form-group{{ $errors->has('sinopsis') ? ' has-error' : '' }}">
				<label for="sinopsis" class="col-sm-3 control-label">Sinopsis:</label>
				<div class="col-sm-9">
