<div class="row">
	<div class="col-md-9 col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('user_name')) has-error @endif">
			<label for="user_name" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Username:</label>
		...
		<div class="form-group @if ($errors->has('name')) has-error @endif">
			<label for="name" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Display Name:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('jenis_kelamin')) has-error @endif">
			<label for="jenis_kelamin" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Jenis Kelamin:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('email')) has-error @endif">
			<label for="email" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Email Address:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('password')) has-error @endif">
			<label for="password" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Password:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('password_confirmation')) has-error @endif">
			<label for="password_confirmation" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Confirm Password:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('user_status')) has-error @endif">
			<label for="email" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Role:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('active')) has-error @endif">
			<label for="active" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Active:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('img')) has-error @endif">
			<label for="img" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Profile Picture:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group @if ($errors->has('profile')) has-error @endif">
			<label for="profile" class="col-sm-3 col-md-3 col-sm-3 col-md-3 control-label">Profile:</label>
			<div class="col-md-9 col-md-9">
		...
		<div class="form-group">
			<div class="col-md-offset-3 col-md-offset-3 col-md-9 col-md-9">
	...
	<div class="col-sm-3 col-md-3 col-sm-3 col-md-3 col-sm-2 text-center">
		@if ($user->img_user)
