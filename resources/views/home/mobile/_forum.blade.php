...
@foreach ($group->forums()->active()->orderBy('created', 'DESC')->limit(5)->get() as $a)
<div class="row-post">
	<div class="media">
		<div class="media-left media-middle">
			<div class="thumbnail" style="height:60px;width:60px;">
				...
				@else
				<img class="media-object cover" src="/images/logo.png" alt="{{ $a->judul }}">
				@endif
			</div>
		</div>
		<div class="media-body">
			<a href="/forum/{{ $a->foruml_id }}-{{ $a->title_code }}" class="text-bold">{{ str_limit($a->title, 55) }}</a>
			<br>
