<ul class="link-icon text-center">
	...
	<li><a href="/mp3"><i class="fa fa-music"></i><br />Salwa Audio</a></li>
	<li><a href="#" id="radio"><i class="fa fa-pause text-info"></i><br /><span class="text-info">Salwa Radio</span></a></li>
