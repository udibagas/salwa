<div class="list-group">
	<a class="list-group-item" href="/artikel?search={{ request('search')}}">
		<i class="fa fa-file-text"></i> Salwa Aktual
	</a>
	<a class="list-group-item" href="/informasi?search={{ request('search')}}">
		<i class="fa fa-newspaper-o"></i> Salwa Info
	</a>
	<a class="list-group-item" href="/peduli?search={{ request('search')}}">
		<i class="fa fa-heart-o"></i> Salwa Peduli
	</a>
	<a class="list-group-item" href="/pertanyaan?search={{ request('search')}}">
		<i class="fa fa-question-circle"></i> Tanya Ustadz
	</a>
	<a class="list-group-item" href="/kitab?search={{ request('search')}}">
		<i class="fa fa-book"></i> Kitab & Terjemahan
	</a>
	<a class="list-group-item" href="/forum/search?search={{ request('search')}}">
	...
	<a class="list-group-item" href="/video?search={{ request('search')}}">
		<i class="fa fa-video-camera"></i> Salwa Video
	</a>
	<a class="list-group-item" href="/mp3?search={{ request('search')}}">
		<i class="fa fa-music"></i> Salwa Audio
	</a>
	<a class="list-group-item" href="/image?search={{ request('search')}}">
