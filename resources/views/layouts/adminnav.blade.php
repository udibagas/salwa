<div class="panel panel-default">
	<div class="list-group">
		...
		<a class="list-group-item @if (url()->current() == url('comment')) active @endif" href="/comment">
			<i class="fa fa-comments-o"></i> Comments
		</a>
		<a class="list-group-item @if (url()->current() == url('audio/admin')) active @endif" href="/audio/admin">
		...
		<a class="list-group-item @if (url()->current() == url('popup')) active @endif" href="/popup">
