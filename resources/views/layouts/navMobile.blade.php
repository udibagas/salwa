	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-8" style="padding-right:0;margin-right:0;">
				...
				<a href="/" class="logo text-bold text-white text-right" style="font-size:17px;">
					<img src="/images/logo-shadow.png" alt="" style="height:35px;margin-left:8px;display:inline-block;margin-top:-11px;" /> SalamDakwah
				</a>
			</div>
