{!! Form::model($tafsir, ['url' => $url, 'method' => $method, 'class' => 'form-horizontal']) !!}
	...
	<div class="form-group{{ $errors->has('surah_id') ? ' has-error' : '' }}">
		<label for="surah_id" class="col-sm-3 col-md-3 control-label">Surah:</label>
		<div class="col-md-9">
	...
	<div class="form-group{{ $errors->has('from_ayah') ? ' has-error' : '' }}">
		<label for="from_ayah" class="col-sm-3 col-md-3 control-label">Dari Ayat:</label>
		<div class="col-md-9">
	...
	<div class="form-group{{ $errors->has('to_ayah') ? ' has-error' : '' }}">
		<label for="to_ayah" class="col-sm-3 col-md-3 control-label">Sampai Ayat:</label>
		<div class="col-md-9">
