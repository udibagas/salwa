	...
	<table class="table table-striped table-hover">
		<thead>
			...
			<tr>
				<td></td>
				<td>
					<input type="text" name="nama_lokasi" value="{{ request('nama_lokasi') }}" class="form-control" placeholder="Nama Area">
				</td>
				<td>
		...
		<tbody>
			...
			@foreach ($lokasis as $a)
				<tr>
					<td>{{ $i++ }}</td>
					<td><a href="/area/?id_lokasi={{ $a->id_lokasi }}">{{ $a->nama_lokasi }}</a></td>
					<td>
