<span class="list-group-item track" style="padding:20px;" audiourl="/quran_audio/{{ request('qari', 'misyari') }}/{{ str_pad($a->surat_id, 3, '0', STR_PAD_LEFT) }}/{{ str_pad($a->ayat_id, 3, '0', STR_PAD_LEFT) }}.mp3" audio-title="Surah {{ $a->surat->nama }} : {{ $a->ayat_id }}">
