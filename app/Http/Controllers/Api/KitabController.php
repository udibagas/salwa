...
class KitabController extends Controller
{
    ...
    {
        return Kitab::orderBy('updated', 'DESC')->paginate();
    }
    ...
    {
        return Kitab::create($request->all());
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(KitabRequest $request, Kitab $kitab)
    {
        return $kitab->update($request->all());
    }
